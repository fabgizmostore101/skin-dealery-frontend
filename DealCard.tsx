...
import { AmazonIcon, BootsIcon, CultBeautyIcon } from './icons';
...
const RetailerLogo: React.FC<{ retailer?: string }> = ({ retailer }) => {
    switch (retailer) {
        ...
        case 'Lookfantastic': return <span className="text-sm font-bold" style={{fontFamily: 'Arial, sans-serif'}}>lookfantastic</span>;
...
const DealCard: React.FC<DealCardProps> = ({ deal }) => {
    return (
        <div className="bg-white rounded-lg shadow-lg overflow-hidden flex flex-col transition-transform duration-300 hover:scale-105 hover:shadow-2xl h-full">
