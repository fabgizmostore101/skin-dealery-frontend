...
const FilterSidebar: React.FC<FilterSidebarProps> = ({ filters, setFilters, brands, retailers, isOpen, setIsOpen }) => {
                ...
                <div className="space-y-2">
                    {CATEGORIES.map(cat => (
                     ...
                     <button
                        ...
                        className={`w-full text-left px-3 py-2 rounded-md text-sm transition-colors ${filters.category === '' ? 'bg-pink-500 text-white font-semibold' : 'hover:bg-pink-100'}`}
                    >
                        All Categories
                    </button>
                </div>
